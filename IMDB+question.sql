...
SELECT n.name AS actor_name, r.total_votes as total_votes, COUNT(r.movie_id) as movie_count,
...
SELECT name as actress_name, 
	...
	Round(Sum(avg_ratingtotal_votes)/Sum(total_votes),2) AS actress_avg_rating,
